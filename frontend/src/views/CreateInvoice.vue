<template>
  <div class="min-h-screen bg-gray-100">
    ...
    <div class="max-w-5xl mx-auto p-6">
      <h2 class="text-2xl font-bold text-gray-700 mb-6">Create New Invoice</h2>
      ...
      <button
        @click="saveInvoice"
        class="w-full bg-blue-700 hover:bg-blue-800 text-white font-bold py-4 rounded-xl text-xl transition"
      >
        💾 Save Invoice
      </button>
...
async function saveInvoice() {
  ...
  try {
    const res = await fetch('https://my-app-production-d598.up.railway.app/api/invoices', {
      method: 'POST',
      headers,
      body: JSON.stringify({
        ...form.value,
